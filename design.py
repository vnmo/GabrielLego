...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.instruction_label.setMinimumSize(QtCore.QSize(0, 100))
        self.instruction_label.setMaximumSize(QtCore.QSize(1026, 100))
        font = QtGui.QFont()
